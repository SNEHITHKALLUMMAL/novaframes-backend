...
const paymentSchema = new Schema(
  {
    ...
    // Set when a checkout session is created (status: pending) and used to
    // match the later webhook event back to this record. Distinct from
    // providerPaymentId, which is only known once the charge succeeds.
    providerSessionId: {
      type: String,
      default: null,
      index: true,
