...
import { InvalidWebhookSignatureError } from '../../../services/payments/PaymentProvider.js';
...
test('RazorpayPaymentProvider: verifyPaymentSignature verifies a valid signature', () => {
  const provider = makeProvider();
